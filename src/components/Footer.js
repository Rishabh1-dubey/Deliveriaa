        ...
        <div className="flex flex-col">
          ...
          <div className="flex ml-8 mt-1">
            <button className="mx-1">
              <a href="  https://github.com/Rishabh1-dubey" target="_blank">
                <img
            ...
            <button className=" rounded-full mt-2 mb-2 px-2 mx-1">
              <a href="https://twitter.com/rishabhdubey006" target="_blank">
                <img
